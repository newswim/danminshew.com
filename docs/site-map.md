...
Mirrors the README's four pillars, plus writing. Start small; every page earns its place.

## v1 (launch)

- **/** — Home. Short introduction, a few current things, recent writing. Not a dashboard.
- **/about** — Who Dan is: the long version. Interests, values, trajectory. Candidate for the free-associative interest-field treatment (see voice.md).
...
- RSS feed for /writing (and possibly a combined firehose)
- Every page: proper titles, descriptions, OpenGraph; schema.org Person on home/about
- Tags kept minimal or omitted until content volume demands them

...
- **Content drafts** — about, music, projects (incl. a ThisTownSucks description). Workflow: Dan drafts raw → Claude does a voice pass against [voice.md](voice.md). Work page shipped 2026-07-18 with real history pulled from Dan's LinkedIn — Dan to review copy; one open call: include the Jimmy John's delivery years (2007–2012) as a humanizing coda, or leave off (currently off).
